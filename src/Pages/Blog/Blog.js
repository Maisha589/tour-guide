...
const Blog = () => {
    return (
        ...
        <div className='p-5' style={{
            ...
            <h3 className='text-warning p-3 m-3'>1.Difference between authorization and authentication:</h3>
            ...
            <h3 className='text-warning p-3 m-3'>2. Why are you using firebase? What other options do you have to implement authentication?</h3>
            <p>I am using firebase for making my website local to global and for authentication. Also using for the authentication of my website. Alternative of firebase - Parse, back4app, Kinvey etc.  </p>
            <h3 className='text-warning p-3 m-3'>3. What other services does firebase provide other than authentication?</h3>
